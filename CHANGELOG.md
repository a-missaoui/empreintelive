...
### Fixed
- Camera and microphone were refused inside the meeting, without the browser even asking for permission. The page declared both for the meeting domains but not for itself, and a page can only delegate a permission it holds. Both are now declared for the page as well.
